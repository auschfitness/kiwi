...
export const PL_AIRPORT_DECK: Deck = {
  ...
  cards: [
    ...
    { id: 'pl_airport_10', deckId: 'pl_airport', en: 'wjazd', pt: 'entrada (imigração)', exampleHtml: 'To jest mój pierwszy <b>wjazd</b> do Polski.', examplePt: 'Essa é a minha primeira entrada na Polônia.', pos: 'noun' },
    { id: 'pl_airport_11', deckId: 'pl_airport', en: 'wyjazd', pt: 'saída (imigração)', exampleHtml: 'To jest mój <b>wyjazd</b> z Polski.', examplePt: 'Essa é a minha saída da Polônia.', pos: 'noun' },
