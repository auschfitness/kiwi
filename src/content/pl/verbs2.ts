...
export const PL_VERBS2_DECK: Deck = {
  ...
  cards: [
    ...
    { id: 'pl_verbs2_2', deckId: 'pl_verbs2', en: 'słyszeć', pt: 'ouvir', exampleHtml: 'Nie chcę tego <b>słyszeć</b>.', examplePt: 'Eu não quero ouvir isso.', pos: 'verb' },
    ...
    { id: 'pl_verbs2_5', deckId: 'pl_verbs2', en: 'pisać', pt: 'escrever', exampleHtml: 'Muszę <b>pisać</b> po polsku.', examplePt: 'Eu preciso escrever em polonês.', pos: 'verb' },
    ...
    { id: 'pl_verbs2_15', deckId: 'pl_verbs2', en: 'kochać', pt: 'amar', exampleHtml: 'Zawsze będę cię <b>kochać</b>.', examplePt: 'Eu vou te amar sempre.', pos: 'verb' },
  ],
}
